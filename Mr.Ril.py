...
figlet Tools Mr.Ril | lolcat

echo -e  "_____________________________________________________________"
echo -e  "Tools    : BerrilFv $white " | lolcat
echo -e  "Creadby  : Mr.Ril $white " |lolcat
echo -e  "Contact  : 085711990416 $white " | lolcat
echo -e  "_____________________________________________________________"
...
3) git clone https://github.com/pashayogi/SETAN 
echo -e "${y} Installer RED_HAWK.."
echo -e "${y} cd SETAN"
echo -e "${y} python2 SETAN.py"
cd /data/data/com.termux/files/home/SETAN/
py /data/data/com.termux/files/home/SETAN/ SETAN.py
;;
...
6) echo "created by : Mr.Rill" | lolcat 
exit
;;
